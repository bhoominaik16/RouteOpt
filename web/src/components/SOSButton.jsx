  ...
  return (
    <>
      ...
      <button
        ...
        disabled={loading}
        className={`fixed bottom-6 right-6 z-40 group flex items-center justify-center w-14 h-14 rounded-full shadow-xl border-4 border-white transition-all duration-300 hover:scale-105 ${
          loading 
